        ...
        <div className="h-40 bg-white/75">
          {language ? (
            <p className="text-xl opacity-1 font-semibold py-10">
              {" "}
              Savourez nos pâtisseries sans-gluten de n'importe où <br />
              et vos papilles gustatives nous remerciera bientôt.{" "}
            </p>
          ) : (
            <p className="text-xl opacity-1 font-semibold py-10">
              {" "}
              Enjoy our baked gluten-free goodies from anywhere <br />
              and your taste buds will thank us soon.{" "}
            </p>
          )}
        </div>
        <button
          onClick={() => navigate("/TwoBakers/Recipes")}
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 mt-5 px-4 rounded-full hover:scale-105 transition ease-in-out"
        >
          EXPLORE
        </button>
      </div>
