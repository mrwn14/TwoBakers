    ...
    <nav className="sticky top-0 z-50 px-10 py-5 mx-auto bg-navPrimary">
      <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
        <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
          <a
            className="text-sm flex font-bold leading-relaxed mr-4 py-2 whitespace-nowrap uppercase text-white cursor-pointer"
        ...
        <div
          className={
            "lg:flex flex-grow items-center" + (expand ? " flex" : " hidden")
          }
        >
          <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
            <li className="nav-item justify-center">
              <a
                className="px-3 py-2 flex items-center text-lg text-black hover:opacity-50 cursor-pointer"
                onClick={() => navigate("/TwoBakers")}
              >
            ...
            <li className="nav-item">
              <a
                className="px-3 py-2 flex items-center text-lg text-black hover:opacity-50 cursor-pointer"
                onClick={() => navigate("/TwoBakers/About")}
              >
            ...
            <li className="nav-item">
              <a
                className="px-3 py-2 flex items-center text-lg text-black hover:opacity-50 cursor-pointer"
                onClick={() => navigate("/TwoBakers/Contact")}
              >
