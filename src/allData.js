...
import pie from "./assets/applepie.jpg";
...
export default [
    ...
    },
    {
        ...
        image: bagels,
        title: 'GLAZED BAGELS',
        titleFR : 'BAGELS GLAÇÉS',
        category: 'dessert',
        categoryFR: 'dessert',
        description: "Who doesn't love bagels? We offer a variety of glazed bagels that you can make on your own.",
        descriptionFR: "Qui n'aime pas les bagels ? Nous proposons une variété de bagels glacés que vous pouvez préparer vous-même.",
    ...
    },
    {
        ...
        titleFR : 'CHEESCAKE',
        categoryFR : 'dessert',
        descriptionFR : "Vous vous rappelez la première fois que vous avez goûté un gâteau au fromage ? Eh bien, en goûtant celui-ci, vous ressentirez la même sensation que ce jour-là.",
    ...
    },
    {
        ...
        titleFR : 'TARTE AUX POMMES',
        categoryFR : 'dessert',
        descriptionFR : "Pour tous ceux qui ne se lassent pas des tartes, cette tarte aux pommes est facile à faire et plutôt saine pour une tarte aussi bonne.",
    ...
    },
    {
        ...
        titleFR : 'GÂTEAU AU CHOCOLAT',
        categoryFR : 'dessert',
        descriptionFR : "Pour vos jours d'abstinence, cette friandise au chocolat vous fera attendre le prochain jour d'abstinence.",
    ...
    },
    {
        ...
        titleFR : 'PAIN DE BLÉ ENTIER',
        categoryFR : 'pains',
        descriptionFR : "Rien d'extraordinaire, juste du pain que vous pouvez griller le matin pour votre petit-déjeuner, mais certainement meilleur que tout ce que vous trouvez au supermarché.",
    ...
    },
    {
        ...
        category: 'pizza',
        description: 'If you had to choose one pizza to eat for the rest of your life, it would definitely be this one.',
        titleFR : 'PIZZA VÉGÉTARIENNE',
        categoryFR : 'pizza',
        descriptionFR : "Si vous deviez choisir une pizza à manger pour le reste de votre vie, ce serait sans aucun doute celle-ci.",
